...
def main():
    ...
    <style>
        ...
        /* Текст внутри селектов (выпадающих списков) в сайдбаре — ТЁМНЫЙ */
        ...
        /* Текст внутри полей ввода в сайдбаре — ТЁМНЫЙ */
        ...
        .dataframe { border-radius: 12px; overflow: hidden; color: #000000 !important; background-color: #ffffff !important; }
        .stDataFrame { overflow-x: auto; }
        .stAlert, .stToast, .stInfo, .stWarning, .stSuccess, .stError { color: #000000 !important; }
    </style>

...
def main():
    ...
    <style>
        ...
        .stApp .stMarkdown, .stApp .stTextInput label, .stApp .stNumberInput label,
        .stApp .stDateInput label, .stApp .stTextArea label, .stApp .stSelectbox label,
        .stApp .stRadio label, .stApp .stCheckbox label, .stApp .stMetric label,
        .stApp .stMetric div, .stApp .stDataFrame, .stApp table, .stApp .stAlert,
        .stApp .stInfo, .stApp .stWarning, .stApp .stSuccess, .stApp .stError,
        .stApp .stToast, .stApp .stException {
        ...
        /* Обычные кнопки в основной области */
        ...
        /* Сайдбар — кнопка выхода (светлая на тёмном фоне) */
        ...
        /* Сайдбар — информационные сообщения */
        [data-testid="stSidebar"] .stInfo, [data-testid="stSidebar"] .stWarning {
            color: #ffffff !important;
